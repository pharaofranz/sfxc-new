...
if __name__ == "__main__":
    ...
    p.add_argument("-m", "--machines",
                   default="k,l", type=str,
                   help="Machines to run correlator nodes on, default='k,l', allowed values are k,l,m,n,o ; it is also possible to list individual machines e.g. k1,k2")
